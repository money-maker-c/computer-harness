/** Headless version checks against the public Computer Harness Desktop release service. */

/** Public endpoint returning the latest stable Computer Harness Desktop version. */
...
/**
 * Check the fixed Computer Harness Desktop version endpoint for a newer stable release.
