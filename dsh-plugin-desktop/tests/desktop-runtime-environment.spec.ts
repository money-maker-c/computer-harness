...
function options(
  ...
  return {
    ...
    appExecutable: platform === 'win32'
      ? 'C:\\Program Files\\DSH 100% Desktop\\Computer Harness Desktop.exe'
      : "/Applications/DSH O'Brien.app/Contents/MacOS/Computer Harness Desktop",
    pnpmBinPath: platform === 'win32'
      ? 'C:\\Program Files\\Computer Harness Desktop\\resources\\app.asar.unpacked\\node_modules\\pnpm\\bin\\pnpm.mjs'
