...
describe('published package surface', () => {
  ...
  it('fixes the installed application identity', () => {
    ...
    expect(manifest.build?.productName).toBe('Computer Harness Desktop')
    ...
    expect(manifest.build?.win?.artifactName).toBe('Computer-Harness-${version}-${arch}-Portable.${ext}')
    expect(manifest.build?.nsis).toEqual({
      ...
      shortcutName: 'Computer Harness Desktop',
      useZip: false,
      artifactName: 'Computer-Harness-${version}-${arch}-Setup.${ext}',
    })
