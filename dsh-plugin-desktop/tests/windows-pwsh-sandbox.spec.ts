...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\Computer Harness Desktop\\Computer Harness Desktop.exe',
  upstreamRunner: 'C:\\Program Files\\Computer Harness Desktop\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\Computer Harness Desktop\\resources\\app.asar\\desktop-runner.js',
}
